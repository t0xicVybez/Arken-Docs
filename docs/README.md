...
ArkenBot is a fully-featured Discord bot built for community management, moderation, leveling, music, and much more. It comes with a powerful web dashboard for managing every setting without needing to type a single command.

## What can ArkenBot do?
...
| **Stream Alerts** | Notifications for Twitch, Kick, YouTube, RSS |
...
| **Languages** | Fully translated into 14 languages — bot, dashboard, and site — with automatic per-user detection |

## Dashboard

Everything is managed through the web dashboard at your dashboard URL. Log in with Discord to access your servers.

## Self-Hosting

ArkenBot is fully open source. You can download the source code and run your own instance on any Linux server.

- **Repository:** [github.com/t0xicVybez/ArkenBot](https://github.com/t0xicVybez/ArkenBot)
- **Self-Hosting Docs:** [docs.arkenbot.app/self-hosting/overview](https://docs.arkenbot.app/self-hosting/overview)

See the [Self-Hosting Overview](self-hosting/overview.md) for full setup instructions covering prerequisites, Discord application setup, database configuration, and production deployment with PM2 and Nginx.

## Quick Links

- [Quick Start Guide](setup/quick-start.md) — Get up and running in 5 minutes
- [Command Reference](commands/moderation.md) — Full command list
- [Addon Overview](addons/overview.md) — Extend the bot with addons
- [Self-Hosting Guide](self-hosting/overview.md) — Run your own instance
