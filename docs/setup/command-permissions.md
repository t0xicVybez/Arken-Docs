...
Custom commands (created in the **Custom Commands** section) have their own per-command role restrictions configured when the command is created. See [Custom Commands](/setup/custom-commands) for details.
